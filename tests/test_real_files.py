...
class RealFileParserTest:
    ...
    def save_result(self, file_type, result, parse_time):
        ...
        # 保存到结果字典
        self.results[file_type] = {"success": True, "parse_time": parse_time, "result_length": len(str(result)), "result_type": str(type(result)), "result_file": str(result_file)}
    ...
    def save_error(self, file_type, error, parse_time):
        ...
        # 保存到结果字典
        self.results[file_type] = {"success": False, "parse_time": parse_time, "error": str(error), "error_file": str(error_file)}
